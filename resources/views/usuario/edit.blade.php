            ...
            <form method="POST" action="{{route('usuario.update',$user->id)}}">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group-sm {{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control input-sm" name="name" id="name" value="{{ $user->name }}" required>
                    ...
                    <div class="form-group {{ $errors->has('apellidos') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control input-sm" name="apellidos" id="apellidos" value="{{ $user->apellidos }}" required>
                    ...
                    <div class="form-group {{ $errors->has('usuario') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control input-sm" name="usuario" id="usuario" value="{{$user->usuario}}" required>
                    ...
                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control input-sm" name="email" id="email" value="{{ $user->email }}" required>
                    ...
                    <div class="form-group {{ $errors->has('rol') ? ' has-error' : '' }}">
                        ...
                        <select name="idrol" id="idrol" class="form-control input-sm" required>
                            ...
                            <option value="{{$rol->idrol}}" @if($rol->idrol==$user->idrol) selected @endif() >{{$rol->rol}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group {{ $errors->has('estado') ? ' has-error' : '' }}">
                        ...
                        <select name="estado" id="estado" class="form-control input-sm" required>
                            ...
                            <option value="{{$key}}" @if($key==$user->estado) selected @endif() >{{$estado}}</option>
                            @endforeach()
