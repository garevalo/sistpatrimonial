    ...
    public function rules()
    {
        ...
        if($this->request->has('_method')){
            ...
            $validation = array(
                ...
                'denom_catalogo' => 'required|min:2|max:100|unique:catalogos,denom_catalogo,'.$this->route('catalogo').',denom_catalogo',
            ...
            $validation = array(
                ...
                'denom_catalogo' => 'required|min:2|max:100|unique:catalogos,denom_catalogo',
                'idestado' => 'required|integer',
                'cod_grupo_generico' => 'required',
                'cod_clase_generico' => 'required'
            );
